    ...
    <section className="py-32" style={{ backgroundColor:'#0A0A12' }}>
      <div className="max-w-5xl mx-auto px-6">
        ...
        <motion.div className="grid md:grid-cols-2 gap-6 mb-14" variants={stagger} initial="hidden" whileInView="visible" viewport={viewportOnce}>
          <motion.div variants={fadeUp} className="glass-card p-10" style={{ borderTop:'2px solid rgba(0,255,136,0.4)', boxShadow:'0 0 30px rgba(0,255,136,0.05)' }}>
          ...
          <motion.div variants={fadeUp} className="glass-card p-10" style={{ borderTop:'2px solid rgba(255,80,80,0.3)', boxShadow:'0 0 30px rgba(255,80,80,0.03)' }}>
